    ...
    <main className="mx-auto max-w-[760px] px-4 pb-20">
      ...
      <section className="pt-14">
        ...
        <p className="lead reveal reveal-3 mt-6">
          GEO PULSE — попытка честно ответить на один вопрос. Каждый час система
      ...
      <section className="prose-editorial">
        ...
        <p className="mb-6">
          GEO PULSE создан для тех, кто работает с другими странами от лица России и в
        ...
        <p>
          При этом GEO PULSE — <b>не пропаганда и не её разоблачение</b>. Это
      ...
      <section className="prose-editorial">
        <p className="mb-5">
          GEO PULSE — открытый проект под лицензией <b>AGPL-3.0</b>. Весь код, веса
        ...
        <footer className="border-t border-line pt-8 text-center">
          <p className="pull-quote mx-auto max-w-[540px] text-[20px]">
            GEO PULSE измеряет, как мир говорит о России, — чтобы мы научились лучше
            слышать мир.
          </p>
