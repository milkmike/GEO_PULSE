    ...
    <main className="mx-auto max-w-[760px] px-4 pb-20">
      ...
      <section className="pt-14">
        ...
        <h1 className="display reveal reveal-2 mt-4 text-[38px] leading-[1.12] sm:text-[52px]">
          Массаракш&nbsp;— это «мир наизнанку»
        </h1>
        <p className="lead reveal reveal-3 mt-6">
          Так ругаются у Стругацких на планете Саракш — там башни-ретрансляторы день
          и ночь объясняли жителям, кто их враг. Наш мир устроен тоньше, но медиаполе
          вокруг России работает с не меньшим усердием. Каждый час мы читаем сотни СМИ
          на десятках языков и меряем это поле для 99 стран — без купюр и без
          украшательств.
        </p>
      ...
      <section className="prose-editorial">
        <p className="dropcap mb-4">
          Изнутри страны невозможно увидеть себя со стороны — оптика не та. До нас доходят
          либо пересказы, либо чьи-то интерпретации: каждый передатчик в мировом медиаполе
          вещает свою правду, и у каждой правды есть хозяин. Стругацкие называли это
          коротко: массаракш — мир наизнанку.
        </p>
        <p className="mb-4">
          Мы не умеем выключать чужие башни. Мы умеем мерить их излучение. Информационное
          поле — это поле битвы, нравится нам это или нет, и первое правило поля — знать,
          кто перед тобой: <b>союзник, партнёр, нейтрал или противник</b>.
        </p>
        <p className="mb-6">
        ...
        <blockquote className="pull-quote my-10 border-l-2 border-ru-red pl-6">
          Мы не умеем выключать чужие башни — мы умеем мерить их излучение.
        </blockquote>
        <p className="mb-4">
        ...
        <p>
          При этом «Массаракш» — <b>не пропаганда и не контрпропаганда</b>. Это
          измерительный прибор. Прибору всё равно, что вы хотели бы увидеть, — он
          показывает как есть, объясняет методику и честно говорит о её пределах:
          завышенные ожидания подводят специалиста так же, как и отсутствие данных.
        </p>
      </section>
      ...
      <section className="prose-editorial">
        <p className="mb-6">
          ...
          число от −100 до +100. Это не «правда в последней инстанции» — таких приборов
          не существует, что бы вам ни обещали. Это взвешенная сумма проверяемых фактов
          и измеримого медиафона. Индекс складывается из трёх
          частей:
        </p>
      ...
      <section className="prose-editorial">
        <p className="mb-5">
          ...
          Мы хотим, чтобы вы доверяли «Массаракшу» ровно настолько, насколько он того
          ...
          {[
            {
              ...
              t: " Пресса страны может быть жёстче или мягче, чем настроения её жителей: башни всегда говорят громче людей. Мы измеряем медиаполе, а не опросы общественного мнения.",
            },
            {
      ...
      <section className="prose-editorial">
        <p className="mb-5">
          ...
          схемой — тоже немножко башня. Весь код, веса индекса и реестр стран доступны
          на GitHub — методику можно проверить, оспорить или улучшить:
        </p>
        ...
        <footer className="border-t border-line pt-8 text-center">
          <p className="pull-quote mx-auto max-w-[540px] text-[20px]">
            «Массаракш» меряет излучение мирового медиаполя — чтобы видеть мир
            как он есть. Не наизнанку.
          </p>
