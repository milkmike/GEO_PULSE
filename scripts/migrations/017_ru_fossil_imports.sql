...
-- Per-country cumulative imports of Russian fossil fuels (€ and tonnes) since 2022,
-- with a per-commodity breakdown and a world rank by euros paid to Russia.
...
CREATE TABLE IF NOT EXISTS ru_fossil_imports (
    ...
    period_from  DATE,                          -- cumulation start
